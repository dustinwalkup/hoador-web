...
import { unarchiveConversationAction } from "../unarchive-conversation";
...
describe("unarchiveConversationAction", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("should unarchive conversation successfully", async () => {
    ...
    expect(tryCatch).toHaveBeenCalledWith(
      messagesDAL.unarchiveConversation(conversationId, mockUser1.id),
    );
