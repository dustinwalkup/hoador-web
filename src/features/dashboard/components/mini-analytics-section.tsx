...
/**
 * Mini analytics with colored top borders, bar indicators, and progress rings.
 */
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid min-w-0 grid-cols-1 gap-4 md:grid-cols-3">
        {/* Rentals */}
        <Card className="min-w-0 border-t-4 border-t-sky-500">
        ...
        {/* Earnings */}
        <Card className="min-w-0 border-t-4 border-t-emerald-500">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-2 text-sm font-medium">
        ...
        {/* Inventory */}
        <Card className="min-w-0 border-t-4 border-t-amber-500">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-2 text-sm font-medium">
