      ...
      <DialogContent className="max-h-[85vh] max-w-lg overflow-y-auto sm:max-w-lg">
        ...
        <div className="text-muted-foreground space-y-4 text-sm">
          ...
          <section className="space-y-2">
            ...
            <p>
              After the owner confirms the tool is back (or the service is
              done), there&apos;s a{" "}
              <strong className="text-foreground font-medium">24-hour</strong>{" "}
              window for either side to flag a problem. No money moves during
              that window.
            </p>
            <p>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-2 pl-4">
              ...
              <li>
                ...
                full refund of the rental or service price. The service fee is
                not refunded.
              </li>
              <li>
                <span className="text-foreground font-medium">
          ...
          <section className="space-y-2">
            ...
            <p>
              The service fee covers payment processing (Stripe charges about
              2.9% + $0.30 per transaction). You&apos;ll always see it broken
              out in the price summary before you confirm. It&apos;s not
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              automatically. You&apos;re only charged if a damage claim is filed
              and upheld during the dispute window.
            </p>
          </section>
        </div>
      </DialogContent>
