...
| SHARE-06 | P1  | Out-of-network user | Open a shared need link for a need outside your network                           | Neutral **"not available in your area"** state — need content is **not** shown          | R13.5, Edge 6 | ✅ Pass — 2026-07-07 (no content leak — Critical bar met); ⚠️ shows generic 404, not branded "not available in your area" copy — R13.5 polish gap |
...
| DET-05 | P1  | Out-of-network user  | Open a need detail URL you cannot see | **404 / not found** (creator and admins are the only exceptions)                                                                                  | R6.2 | ✅ Pass — 2026-07-07 |
...
| E2E-02 | P1  | Requester + Out-of-network user          | Post a need, then verify it across one in-network and one out-of-network viewer (feed, detail, shared link)                                                                                                                                                 | In-network viewer sees it everywhere it should; out-of-network viewer never sees it on any surface                                                                                                                                                                                                 | Success Criteria 2   | ✅ Pass — 2026-07-07 (by composition: FEED-01/02 + DET-01/05 + SHARE-06)               |
