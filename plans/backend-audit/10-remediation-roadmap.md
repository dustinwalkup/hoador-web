...
| 9     | R-CONC-02                  | P0       | M      | R-BIZ-05 (shared payout code), R-TEST-HARNESS | DONE (2026-09-24, uncommitted; payout filter adds only NOT EXISTS refunded — BIZ-05 cron needs non-pending transfer rows; prior-refund repair skips owner transfer) |
